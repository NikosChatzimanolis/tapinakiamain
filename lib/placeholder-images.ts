...
export const IMAGES = {
  ...
  gallery: [
    ...
    { src: '/images/terrace-table-setting.webp', alt: 'Table setting on the terrace', width: 3696, height: 2448 },
    { src: '/images/terrace-summer-evening.webp', alt: 'Busy terrace on a summer evening', width: 1080, height: 1350 },
    { src: '/images/spirits-collection.webp', alt: 'Spirits and bottles collection', width: 3696, height: 2448 },
    ...
    { src: '/images/set-for-dinner.webp', alt: 'Tables set for dinner', width: 5184, height: 3456 },
